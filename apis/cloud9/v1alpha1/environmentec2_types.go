...
type EnvironmentEC2Spec struct {
	...
	OwnerArn string `json:"ownerArn,omitempty" cloudformation:"OwnerArn,Parameter"`
	...
	Repositories []EnvironmentEC2_Repository `json:"repositories,omitempty" cloudformation:"Repositories,Parameter"`
	...
	SubnetId string `json:"subnetId,omitempty" cloudformation:"SubnetId,Parameter"`
}
...
// +kubebuilder:resource:categories=aws;all;cloud9
