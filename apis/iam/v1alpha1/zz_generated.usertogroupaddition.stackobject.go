...
func (in *UserToGroupAddition) GetTemplate(client dynamic.Interface) (string, error) {
	...
	template.Description = "AWS Controller - iam.UserToGroupAddition (ac-{TODO})"
	...
	template.Resources = map[string]cloudformation.Resource{
		"UserToGroupAddition": iamUserToGroupAddition,
	}
...
func (in *UserToGroupAddition) GenerateStackName() string {
	return strings.Join([]string{"iam", "usertogroupaddition", in.GetName(), in.GetNamespace()}, "-")
}
...
func (in *UserToGroupAddition) GetStatus() metav1alpha1.ConditionStatus {
