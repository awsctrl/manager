...
type LayerVersionSpec struct {
	...
	Content LayerVersion_Content `json:"content" cloudformation:"Content"`
...
type LayerVersion_Content struct {
	...
	S3Key string `json:"s3Key" cloudformation:"S3Key,Parameter"`
	...
	S3Bucket string `json:"s3Bucket" cloudformation:"S3Bucket,Parameter"`
}
