...
func (in *EventSourceMapping) GetTemplate(client dynamic.Interface) (string, error) {
	...
	template.Description = "AWS Controller - lambda.EventSourceMapping (ac-{TODO})"
	...
	template.Resources = map[string]cloudformation.Resource{
		"EventSourceMapping": lambdaEventSourceMapping,
	}
...
func (in *EventSourceMapping) GenerateStackName() string {
	return strings.Join([]string{"lambda", "eventsourcemapping", in.GetName(), in.GetNamespace()}, "-")
}
