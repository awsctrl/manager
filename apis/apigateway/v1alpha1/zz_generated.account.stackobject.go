...
import (
	...
	"github.com/awslabs/goformation/v3/cloudformation/apigateway"
...
func (in *Account) GetTemplate() (string, error) {
	template := goformation.NewTemplate()

	template.Description = "AWS Controller - AWS::ApiGateway::Account (ac-0owrq417x)"

	template.Parameters["CloudWatchRoleArn"] = cfnhelpers.Parameter{
		Type:        "String",
	...
	template.Conditions["HasCloudWatchRoleArn"] = goformation.Not([]string{goformation.Equals("", goformation.Ref("CloudWatchRoleArn"))})

	template.Resources["Account"] = &apigateway.Account{
		CloudWatchRoleArn: goformation.If("HasCloudWatchRoleArn", goformation.Ref("CloudWatchRoleArn"), goformation.Ref("AWS::NoValue")),
	}
