...
type RestApi_EndpointConfiguration struct {
	...
	// VpcEndpointRefs http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigateway-restapi-endpointconfiguration.html#cfn-apigateway-restapi-endpointconfiguration-vpcendpointids
	VpcEndpointRefs []metav1alpha1.ObjectReference `json:"vpcEndpointRefs,omitempty" cloudformation:"VpcEndpointIds"`
}
