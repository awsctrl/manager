...
// Load the iam User resource
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=users/status,verbs=get;update;patch
