...
// Load the iam ServiceLinkedRole resource
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=servicelinkedroles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=servicelinkedroles/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *ServiceLinkedRoleReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("ServiceLinkedRole", req.NamespacedName)

	var err error
	var instance v1alpha1.ServiceLinkedRole
