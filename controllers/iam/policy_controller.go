...
// Load the iam Policy resource
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=policies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=policies/status,verbs=get;update;patch
