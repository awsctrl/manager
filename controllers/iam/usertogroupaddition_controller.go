...
// Load the iam UserToGroupAddition resource
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=usertogroupadditions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=usertogroupadditions/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *UserToGroupAdditionReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("UserToGroupAddition", req.NamespacedName)

	var err error
	var instance v1alpha1.UserToGroupAddition
...
func (r *UserToGroupAdditionReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&v1alpha1.UserToGroupAddition{}).
