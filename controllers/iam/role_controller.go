...
// Load the iam Role resource
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=roles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=roles/status,verbs=get;update;patch
