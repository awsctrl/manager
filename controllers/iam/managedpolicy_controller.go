...
// Load the iam ManagedPolicy resource
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=managedpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=managedpolicies/status,verbs=get;update;patch
...
func (r *ManagedPolicyReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	var err error
	var instance v1alpha1.ManagedPolicy
