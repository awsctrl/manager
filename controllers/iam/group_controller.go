...
// Load the iam Group resource
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=groups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=groups/status,verbs=get;update;patch
