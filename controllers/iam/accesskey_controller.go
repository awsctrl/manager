...
// Load the iam AccessKey resource
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=accesskeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.awsctrl.io,resources=accesskeys/status,verbs=get;update;patch
...
func (r *AccessKeyReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	var err error
	var instance v1alpha1.AccessKey
