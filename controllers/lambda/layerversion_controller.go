...
// Load the lambda LayerVersion resource
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=layerversions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=layerversions/status,verbs=get;update;patch
...
func (r *LayerVersionReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	log := r.Log.WithValues("LayerVersion", req.NamespacedName)

	var err error
	var instance v1alpha1.LayerVersion
