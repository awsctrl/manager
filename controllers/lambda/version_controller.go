...
// Load the lambda Version resource
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=versions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=versions/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *VersionReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("Version", req.NamespacedName)

	var err error
	var instance v1alpha1.Version
