...
// Load the lambda EventInvokeConfig resource
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=eventinvokeconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=eventinvokeconfigs/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *EventInvokeConfigReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("EventInvokeConfig", req.NamespacedName)

	var err error
	var instance v1alpha1.EventInvokeConfig
...
func (r *EventInvokeConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&v1alpha1.EventInvokeConfig{}).
