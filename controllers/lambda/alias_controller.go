...
// Load the lambda Alias resource
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=aliases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=aliases/status,verbs=get;update;patch
