...
// Load the lambda Function resource
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=functions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.awsctrl.io,resources=functions/status,verbs=get;update;patch
...
func (r *FunctionReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	var err error
	var instance v1alpha1.Function
