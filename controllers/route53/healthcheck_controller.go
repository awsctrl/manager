...
// Load the route53 HealthCheck resource
// +kubebuilder:rbac:groups=route53.awsctrl.io,resources=healthchecks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53.awsctrl.io,resources=healthchecks/status,verbs=get;update;patch
...
func (r *HealthCheckReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	var err error
	var instance v1alpha1.HealthCheck
