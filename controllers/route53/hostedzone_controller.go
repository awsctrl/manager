...
// Load the route53 HostedZone resource
// +kubebuilder:rbac:groups=route53.awsctrl.io,resources=hostedzones,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53.awsctrl.io,resources=hostedzones/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *HostedZoneReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("HostedZone", req.NamespacedName)

	var err error
	var instance v1alpha1.HostedZone
