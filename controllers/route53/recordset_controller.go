...
// Load the route53 RecordSet resource
// +kubebuilder:rbac:groups=route53.awsctrl.io,resources=recordsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53.awsctrl.io,resources=recordsets/status,verbs=get;update;patch
...
func (r *RecordSetReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	log := r.Log.WithValues("RecordSet", req.NamespacedName)

	var err error
	var instance v1alpha1.RecordSet
