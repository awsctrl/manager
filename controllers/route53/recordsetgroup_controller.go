...
// Load the route53 RecordSetGroup resource
// +kubebuilder:rbac:groups=route53.awsctrl.io,resources=recordsetgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53.awsctrl.io,resources=recordsetgroups/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *RecordSetGroupReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("RecordSetGroup", req.NamespacedName)

	var err error
	var instance v1alpha1.RecordSetGroup
