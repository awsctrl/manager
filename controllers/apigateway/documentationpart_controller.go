...
// Load the apigateway DocumentationPart resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=documentationparts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=documentationparts/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *DocumentationPartReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("DocumentationPart", req.NamespacedName)

	var err error
	var instance v1alpha1.DocumentationPart
