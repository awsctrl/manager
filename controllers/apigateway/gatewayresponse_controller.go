...
// Load the apigateway GatewayResponse resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=gatewayresponses,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=gatewayresponses/status,verbs=get;update;patch
...
func (r *GatewayResponseReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	log := r.Log.WithValues("GatewayResponse", req.NamespacedName)

	var err error
	var instance v1alpha1.GatewayResponse
