...
// Load the apigateway ApiKey resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=apikeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=apikeys/status,verbs=get;update;patch
