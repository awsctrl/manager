...
// Load the apigateway RequestValidator resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=requestvalidators,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=requestvalidators/status,verbs=get;update;patch
...
func (r *RequestValidatorReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	log := r.Log.WithValues("RequestValidator", req.NamespacedName)

	var err error
	var instance v1alpha1.RequestValidator
