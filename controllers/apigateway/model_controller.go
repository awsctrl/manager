...
// Load the apigateway Model resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=models,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=models/status,verbs=get;update;patch
