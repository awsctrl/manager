...
// Load the apigateway Resource resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=resources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=resources/status,verbs=get;update;patch
...
func (r *ResourceReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	var err error
	var instance v1alpha1.Resource
