...
// Load the apigateway UsagePlanKey resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=usageplankeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=usageplankeys/status,verbs=get;update;patch
...
func (r *UsagePlanKeyReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	log := r.Log.WithValues("UsagePlanKey", req.NamespacedName)

	var err error
	var instance v1alpha1.UsagePlanKey
