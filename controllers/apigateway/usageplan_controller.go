...
// Load the apigateway UsagePlan resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=usageplans,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=usageplans/status,verbs=get;update;patch
...
func (r *UsagePlanReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	log := r.Log.WithValues("UsagePlan", req.NamespacedName)

	var err error
	var instance v1alpha1.UsagePlan
