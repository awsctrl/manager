...
// Load the apigateway BasePathMapping resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=basepathmappings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=basepathmappings/status,verbs=get;update;patch
...
func (r *BasePathMappingReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	log := r.Log.WithValues("BasePathMapping", req.NamespacedName)

	var err error
	var instance v1alpha1.BasePathMapping
