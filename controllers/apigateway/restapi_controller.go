...
// Load the apigateway RestApi resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=restapis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=restapis/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *RestApiReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("RestApi", req.NamespacedName)

	var err error
	var instance v1alpha1.RestApi
