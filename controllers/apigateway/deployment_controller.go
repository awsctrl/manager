...
// Load the apigateway Deployment resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=deployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=deployments/status,verbs=get;update;patch
...
func (r *DeploymentReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	var err error
	var instance v1alpha1.Deployment
