...
// Load the apigateway Method resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=methods,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=methods/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *MethodReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("Method", req.NamespacedName)

	var err error
	var instance v1alpha1.Method
