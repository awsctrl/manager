...
// Load the apigateway DomainName resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=domainnames,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=domainnames/status,verbs=get;update;patch
...
func (r *DomainNameReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	var err error
	var instance v1alpha1.DomainName
