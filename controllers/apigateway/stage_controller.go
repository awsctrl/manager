...
// Load the apigateway Stage resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=stages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=stages/status,verbs=get;update;patch
