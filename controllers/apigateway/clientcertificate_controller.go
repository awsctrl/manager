...
// Load the apigateway ClientCertificate resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=clientcertificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=clientcertificates/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *ClientCertificateReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("ClientCertificate", req.NamespacedName)

	var err error
	var instance v1alpha1.ClientCertificate
