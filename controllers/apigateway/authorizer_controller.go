...
// Load the apigateway Authorizer resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=authorizers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=authorizers/status,verbs=get;update;patch
...
func (r *AuthorizerReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	log := r.Log.WithValues("Authorizer", req.NamespacedName)

	var err error
	var instance v1alpha1.Authorizer
