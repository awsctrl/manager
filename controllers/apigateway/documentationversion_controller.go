...
// Load the apigateway DocumentationVersion resource
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=documentationversions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.awsctrl.io,resources=documentationversions/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *DocumentationVersionReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("DocumentationVersion", req.NamespacedName)

	var err error
	var instance v1alpha1.DocumentationVersion
