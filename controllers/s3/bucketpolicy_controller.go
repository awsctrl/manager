...
// Load the s3 BucketPolicy resource
// +kubebuilder:rbac:groups=s3.awsctrl.io,resources=bucketpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3.awsctrl.io,resources=bucketpolicies/status,verbs=get;update;patch

// Reconcile will make the desired state a reality
func (r *BucketPolicyReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	log := r.Log.WithValues("BucketPolicy", req.NamespacedName)

	var err error
	var instance v1alpha1.BucketPolicy
...
func (r *BucketPolicyReconciler) SetupWithManager(mgr ctrl.Manager) error {
