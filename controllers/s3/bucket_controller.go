...
// Load the s3 Bucket resource
// +kubebuilder:rbac:groups=s3.awsctrl.io,resources=buckets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3.awsctrl.io,resources=buckets/status,verbs=get;update;patch
