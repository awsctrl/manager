...
// RunApiKeySpecs allows all instance E2E tests to run
var _ = Describe("Run Apigateway ApiKey Controller", func() {

	Context("Without ApiKey{} existing", func() {

		It("Should create apigateway.ApiKey{}", func() {
			var stackID string
			...
			instance := &apigatewayv1alpha1.ApiKey{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-apikey-",
					Namespace:    podnamespace,
				},
				Spec: apigatewayv1alpha1.ApiKeySpec{
					Name:        "sample-apikey",
			...
			By("Creating new Apigateway ApiKey")
			...
			Eventually(func() bool {
				By("Getting latest Apigateway ApiKey")
				instance = &apigatewayv1alpha1.ApiKey{}
