...
// RunDomainNameSpecs allows all instance E2E tests to run
var _ = Describe("Run Apigateway DomainName Controller", func() {

	Context("Without DomainName{} existing", func() {

		It("Should create apigateway.DomainName{}", func() {
			var stackID string
			...
			instance := &apigatewayv1alpha1.DomainName{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-domainname-",
					Namespace:    podnamespace,
				},
				Spec: apigatewayv1alpha1.DomainNameSpec{
					DomainName: "test-domain.awsctrl.io",
				},
			}
			By("Creating new Apigateway DomainName")
			...
			Eventually(func() bool {
				By("Getting latest Apigateway DomainName")
				instance = &apigatewayv1alpha1.DomainName{}
			...
			By("Deleting Apigateway DomainName")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting DomainName Stack")
