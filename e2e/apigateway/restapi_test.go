...
// RunRestApiSpecs allows all instance E2E tests to run
var _ = Describe("Run Apigateway RestApi Controller", func() {

	Context("Without RestApi{} existing", func() {

		It("Should create apigateway.RestApi{}", func() {
			var stackID string
			...
			instance := &apigatewayv1alpha1.RestApi{
			...
			Eventually(func() bool {
				By("Getting latest Apigateway RestApi")
				instance = &apigatewayv1alpha1.RestApi{}
