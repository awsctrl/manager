...
// RunMethodSpecs allows all instance E2E tests to run
var _ = Describe("Run Apigateway Method Controller", func() {

	Context("Without Method{} existing", func() {

		It("Should create apigateway.Method{}", func() {
			var stackID string
			...
			instance := &apigatewayv1alpha1.Method{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-method-",
					Namespace:    podnamespace,
				},
			...
			Eventually(func() bool {
				By("Getting latest Apigateway Method")
				instance = &apigatewayv1alpha1.Method{}
