...
// RunClientCertificateSpecs allows all instance E2E tests to run
var _ = Describe("Run Apigateway ClientCertificate Controller", func() {

	Context("Without ClientCertificate{} existing", func() {

		It("Should create apigateway.ClientCertificate{}", func() {
			var stackID string
			...
			instance := &apigatewayv1alpha1.ClientCertificate{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-clientcertificate-",
					Namespace:    podnamespace,
				},
				Spec: apigatewayv1alpha1.ClientCertificateSpec{
					Description: "A test client certificate",
				},
			}
			By("Creating new Apigateway ClientCertificate")
			...
			Eventually(func() bool {
				By("Getting latest Apigateway ClientCertificate")
				instance = &apigatewayv1alpha1.ClientCertificate{}
			...
			By("Deleting Apigateway ClientCertificate")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting ClientCertificate Stack")
