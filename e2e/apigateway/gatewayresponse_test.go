...
// RunGatewayResponseSpecs allows all instance E2E tests to run
var _ = Describe("Run Apigateway GatewayResponse Controller", func() {

	Context("Without GatewayResponse{} existing", func() {

		It("Should create apigateway.GatewayResponse{}", func() {
			var stackID string
			...
			instance := &apigatewayv1alpha1.GatewayResponse{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-apikey-",
					Namespace:    podnamespace,
				},
				Spec: apigatewayv1alpha1.GatewayResponseSpec{
			...
			By("Creating new Apigateway GatewayResponse")
			...
			Eventually(func() bool {
				By("Getting latest Apigateway GatewayResponse")
				instance = &apigatewayv1alpha1.GatewayResponse{}
