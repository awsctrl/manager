...
// RunBasePathMappingSpecs allows all instance E2E tests to run
var _ = Describe("Run apigateway BasePathMapping Controller", func() {

	Context("Without BasePathMapping{} existing", func() {

		It("Should create apigateway.BasePathMapping{}", func() {
			Skip("Skip apigateway.BasePathMapping{}")
			...
			instance := &apigatewayv1alpha1.BasePathMapping{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-basepathmapping-",
					Namespace:    podnamespace,
				},
				Spec: apigatewayv1alpha1.BasePathMappingSpec{},
			}
			By("Creating new apigateway BasePathMapping")
			...
			Eventually(func() bool {
				By("Getting latest apigateway BasePathMapping")
				instance = &apigatewayv1alpha1.BasePathMapping{}
			...
			By("Deleting apigateway BasePathMapping")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting BasePathMapping Stack")
