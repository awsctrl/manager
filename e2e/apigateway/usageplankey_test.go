...
// RunUsagePlanKeySpecs allows all instance E2E tests to run
var _ = Describe("Run apigateway UsagePlanKey Controller", func() {

	Context("Without UsagePlanKey{} existing", func() {

		It("Should create apigateway.UsagePlanKey{}", func() {
			Skip("Skip apigateway.UsagePlanKey{}")
			...
			instance := &apigatewayv1alpha1.UsagePlanKey{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-usageplankey-",
					Namespace:    podnamespace,
				},
				Spec: apigatewayv1alpha1.UsagePlanKeySpec{},
			}
			By("Creating new apigateway UsagePlanKey")
			...
			Eventually(func() bool {
				By("Getting latest apigateway UsagePlanKey")
				instance = &apigatewayv1alpha1.UsagePlanKey{}
			...
			By("Deleting apigateway UsagePlanKey")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting UsagePlanKey Stack")
