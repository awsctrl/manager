...
// RunVpcLinkSpecs allows all instance E2E tests to run
var _ = Describe("Run apigateway VpcLink Controller", func() {

	Context("Without VpcLink{} existing", func() {

		It("Should create apigateway.VpcLink{}", func() {
			Skip("Skip apigateway.VpcLink{}")
			...
			instance := &apigatewayv1alpha1.VpcLink{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-vpclink-",
					Namespace:    podnamespace,
				},
				Spec: apigatewayv1alpha1.VpcLinkSpec{},
			}
			By("Creating new apigateway VpcLink")
			...
			Eventually(func() bool {
				By("Getting latest apigateway VpcLink")
				instance = &apigatewayv1alpha1.VpcLink{}
			...
			By("Deleting apigateway VpcLink")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting VpcLink Stack")
