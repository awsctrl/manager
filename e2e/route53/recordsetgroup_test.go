...
// RunAccountSpecs allows all recordsetgroup E2E tests to run
var _ = Describe("Run Route53 RecordSetGroup Controller", func() {

	Context("Without RecordSetGroup{} existing", func() {

		It("Should create route53.RecordSetGroup{}", func() {
			var stackID string
			...
			instance := &route53v1alpha1.RecordSetGroup{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-recordsetgroup-",
					Namespace:    podnamespace,
				},
				Spec: route53v1alpha1.RecordSetGroupSpec{
					RecordSets: []route53v1alpha1.RecordSetGroup_RecordSet{
						route53v1alpha1.RecordSetGroup_RecordSet{
							Type:            "A",
			...
			By("Creating new Route53 RecordSetGroup")
			...
			Eventually(func() bool {
				By("Getting latest Route53 RecordSetGroup")
				instance = &route53v1alpha1.RecordSetGroup{}
			...
			By("Deleting Route53 RecordSetGroup")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting Route53 RecordSetGroup Stack")
