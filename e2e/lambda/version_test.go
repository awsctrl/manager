...
var _ = Describe("Run Lambda Version Controller", func() {

	Context("Without Version{} existing", func() {

		It("Should create lambda.Version{}", func() {
			var stackID string
			...
			instance := &lambdav1alpha1.Version{
				ObjectMeta: metav1.ObjectMeta{
			...
			Eventually(func() bool {
				By("Getting latest Lambda Version")
				instance = &lambdav1alpha1.Version{}
			...
			By("Deleting Lambda Version")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting Lambda Version Stack")
