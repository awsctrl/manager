...
Licensed under the Apache License, EventInvokeConfig 2.0 (the "License");
...
var _ = Describe("Run Lambda EventInvokeConfig Controller", func() {

	Context("Without EventInvokeConfig{} existing", func() {

		It("Should create lambda.EventInvokeConfig{}", func() {
			var stackID string
			...
			instance := &lambdav1alpha1.EventInvokeConfig{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-eventinvokeconfig-",
					Namespace:    podnamespace,
				},
				Spec: lambdav1alpha1.EventInvokeConfigSpec{
					FunctionName: "sample-function",
					DestinationConfig: lambdav1alpha1.EventInvokeConfig_DestinationConfig{
						OnFailure: lambdav1alpha1.EventInvokeConfig_OnFailure{
							Destination: "arn:aws:sqs:us-west-2:860055033182:lambda-invoke",
						},
						OnSuccess: lambdav1alpha1.EventInvokeConfig_OnSuccess{
							Destination: "arn:aws:sqs:us-west-2:860055033182:lambda-invoke",
						},
					},
			...
			By("Creating new Lambda EventInvokeConfig")
			...
			Eventually(func() bool {
				By("Getting latest Lambda EventInvokeConfig")
				instance = &lambdav1alpha1.EventInvokeConfig{}
			...
			By("Deleting Lambda EventInvokeConfig")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting Lambda EventInvokeConfig Stack")
