...
var _ = Describe("Run Lambda Function Controller", func() {

	Context("Without Function{} existing", func() {

		It("Should create lambda.Function{}", func() {
			var stackID string
			...
			instance := &lambdav1alpha1.Function{
			...
			Eventually(func() bool {
				By("Getting latest Lambda Function")
				instance = &lambdav1alpha1.Function{}
			...
			By("Deleting Lambda Function")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting Lambda Function Stack")
