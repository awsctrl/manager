...
Licensed under the Apache License, EventSourceMapping 2.0 (the "License");
...
var _ = Describe("Run Lambda EventSourceMapping Controller", func() {

	Context("Without EventSourceMapping{} existing", func() {

		It("Should create lambda.EventSourceMapping{}", func() {
			var stackID string
			...
			instance := &lambdav1alpha1.EventSourceMapping{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-eventsourcemapping-",
					Namespace:    podnamespace,
				},
			...
			By("Creating new Lambda EventSourceMapping")
			...
			Eventually(func() bool {
				By("Getting latest Lambda EventSourceMapping")
				instance = &lambdav1alpha1.EventSourceMapping{}
			...
			By("Deleting Lambda EventSourceMapping")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting Lambda EventSourceMapping Stack")
