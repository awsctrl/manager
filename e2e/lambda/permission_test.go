...
Licensed under the Apache License, Permission 2.0 (the "License");
...
var _ = Describe("Run Lambda Permission Controller", func() {

	Context("Without Permission{} existing", func() {

		It("Should create lambda.Permission{}", func() {
			var stackID string
			...
			instance := &lambdav1alpha1.Permission{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-version-",
					Namespace:    podnamespace,
				},
				Spec: lambdav1alpha1.PermissionSpec{
					FunctionName: "sample-function",
			...
			By("Creating new Lambda Permission")
			...
			Eventually(func() bool {
				By("Getting latest Lambda Permission")
				instance = &lambdav1alpha1.Permission{}
			...
			By("Deleting Lambda Permission")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting Lambda Permission Stack")
