...
// RunAccessKeySpecs allows all instance E2E tests to run
var _ = Describe("Run iam AccessKey Controller", func() {

	Context("Without AccessKey{} existing", func() {

		It("Should create iam.AccessKey{}", func() {
			var stackID string
			...
			instance := &iamv1alpha1.AccessKey{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-accesskey-",
					Namespace:    podnamespace,
				},
				Spec: iamv1alpha1.AccessKeySpec{},
			}
			By("Creating new iam AccessKey")
			...
			Eventually(func() bool {
				By("Getting latest iam AccessKey")
				instance = &iamv1alpha1.AccessKey{}
			...
			By("Deleting iam AccessKey")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting AccessKey Stack")
