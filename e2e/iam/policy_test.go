...
var _ = Describe("Run IAM Policy Controller", func() {

	Context("Without Policy{} existing", func() {

		It("Should create iam.Policy{}", func() {
			var stackID string
			...
			By("Deleting IAM Policy")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting IAM Policy Stack")
