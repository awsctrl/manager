...
var _ = Describe("Run IAM Group Controller", func() {

	Context("Without Group{} existing", func() {

		It("Should create iam.Group{}", func() {
			var stackID string
			...
			By("Deleting IAM Group")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting IAM Group Stack")
