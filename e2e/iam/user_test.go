...
// RunAccountSpecs allows all user E2E tests to run
var _ = Describe("Run IAM User Controller", func() {

	Context("Without User{} existing", func() {

		It("Should create iam.User{}", func() {
			var stackID string
			...
			By("Deleting IAM User")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting IAM User Stack")
