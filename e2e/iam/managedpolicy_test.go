...
var _ = Describe("Run IAM ManagedPolicy Controller", func() {

	Context("Without ManagedPolicy{} existing", func() {

		It("Should create iam.ManagedPolicy{}", func() {
			var stackID string
			...
			instance := &iamv1alpha1.ManagedPolicy{
				ObjectMeta: metav1.ObjectMeta{
					GenerateName: "sample-managedpolicy-",
					Namespace:    podnamespace,
				},
				Spec: iamv1alpha1.ManagedPolicySpec{
					CloudFormationMeta: metav1alpha1.CloudFormationMeta{
						Capabilities: []*string{
							&capabilityIAM,
						},
			...
			By("Creating new IAM ManagedPolicy")
			...
			Eventually(func() bool {
				By("Getting latest IAM ManagedPolicy")
				instance = &iamv1alpha1.ManagedPolicy{}
			...
			By("Deleting IAM ManagedPolicy")
			Expect(k8sclient.Delete(context.Background(), instance)).Should(Succeed())

			By("Deleting IAM ManagedPolicy Stack")
